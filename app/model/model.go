...
type StockInProgress struct {
	...
	StockInsID     int       `validate:"required,min=1" json:"stock_ins_id" sql:"type:integer REFERENCES stock_ins(id) ON DELETE CASCADE ON UPDATE CASCADE"` // belongs to stock in
...
type StockOut struct {
	...
	StausOutCode int       `json:"status_out_code"` // 1. Terjual, 2. Barang Hilang, 3. Rusak, 4 Barang Sample
}
